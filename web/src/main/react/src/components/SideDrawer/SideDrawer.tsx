...
import { Affix, Box, Divider, Group, Paper, Text, Transition } from "@mantine/core"
...
export const SideDrawer: FC<SideDrawerProps> = ({
  ...
  return (
    <Affix position={{ top: 0, right: 0 }} zIndex={zIndex}>
      <Transition mounted={opened} transition={align === "right" ? "slide-left" : "slide-right"} duration={250} timingFunction="ease" keepMounted={keepMounted}>
        {(transitionStyles) => (
