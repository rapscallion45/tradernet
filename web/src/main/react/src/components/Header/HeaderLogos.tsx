...
import TradernetLogoLightMode from "../../../public/formpipe-symbol.svg"
import TradernetLogoDarkMode from "../../../public/formpipe-symbol-white.svg"
 ...
 */
export const HeaderLogos: FC<HeaderLogoProps> = ({ logoLightModeSrc, logoDarkModeSrc, title, logoAlt }) => {
  ...
  return (
    <Group gap={5} wrap={"nowrap"} style={isMobile ? undefined : { cursor: "pointer" }}>
      <Image p={"sm"} src={isDarkMode ? TradernetLogoDarkMode : TradernetLogoLightMode} h={50} w={"auto"} fit={"contain"} alt="Tradernet crest logo" />
