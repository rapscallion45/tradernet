...
The implementation follows `FastAPI route -> ForecastService -> TimescalePriceHistoryRepository -> database`. Binance is an external market-data gateway and remains separate from database persistence.
