...
public final class PortfolioPosition {
    ...
    void setLastKnownPrice(double lastKnownPrice) { this.lastKnownPrice = lastKnownPrice; }
    public double getNetQuantity() { return netQuantity; }
    public double getLastKnownPrice() { return lastKnownPrice; }
    public boolean isFlat() { return Math.abs(netQuantity) < POSITION_EPSILON; }
    public double getAverageCost() { return isFlat() ? 0.0 : Math.abs(netCost / netQuantity); }
