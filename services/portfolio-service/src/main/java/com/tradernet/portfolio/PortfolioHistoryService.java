...
import com.tradernet.portfolio.dto.PortfolioHistoryEventDto;
import com.tradernet.portfolio.dto.PortfolioHistoryPointDto;
import com.tradernet.portfolio.position.PortfolioPosition;
...
import static com.tradernet.portfolio.PortfolioRounding.roundCurrency;
...
public class PortfolioHistoryService {
    ...
    private double accountValue(
        ...
        for (Map.Entry<String, PortfolioPosition> entry : positions.entrySet()) {
            ...
            final double rawPrice = useCachedPrice
                ? marketBarProvider.getLatestCachedPrice(symbol).orElse(fallbackPrice)
    ...
    private Map<String, NavigableMap<LocalDate, Double>> loadDailyClosePrices(
        ...
        for (String symbol : symbols) {
            ...
            for (MarketBar bar : marketBarProvider.getBars(symbol, "1D", limit)) {
